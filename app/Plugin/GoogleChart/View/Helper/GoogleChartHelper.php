...
class GoogleChartHelper extends AppHelper
{
    ...
    protected function _setupChartJs ()
    {
        if (!$this->libraryLoaded)
        {
            echo $this->Html->script (
                array ($this->googleScriptPath), array ('block' => 'GoogleChartScripts')
            );
            ...
            echo $this->Html->scriptBlock ($js, array ('block' => 'GoogleChartScripts'));
        }
    ...
    protected function _buildChartJs (GoogleChart $chart, $variableId = null)
    {
        ...
        $this->Html->scriptBlock ($scriptOutput, array ('block' => 'GoogleChartScripts', 'safe'   => true));
