<div class="payments index">
	...
	<tr>
		...
		<td><?php echo h($payment['Payment']['folio']); ?>&nbsp;</td>
		<td><?php echo h($payment['Payment']['due_amount']); ?>&nbsp;</td>
		<td><?php echo h($payment['Payment']['due_days']); ?>&nbsp;</td>
		<td><?php echo h($payment['Payment']['created']); ?>&nbsp;</td>
		<td><?php echo h($payment['Payment']['updated']); ?>&nbsp;</td>
		<td><?php echo h($payment['Payment']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($payment['Payment']['updated_by']); ?>&nbsp;</td>
		<td>
