...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-imac"></i><?php echo __('Agregar'); ?><br>
            <small><?php echo __('Agregar relacion de estacion de trabajo a solicitud de servicio'); ?></small>
        </h1>
    </div>
</div>
    ...
    <div class="block-content">
        ...
        ?>
            ...
            echo $this->Form->input('servicerequest_id', array(
                ...
                'type' => 'hidden',
                'value' => $servicerequests["Servicerequest"]["id"],
                'readonly' => 'readonly'
            ));
            ?>
            <?php
            echo $this->Form->input('servicerequestname', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('Solicitud')),
                'class' => 'form-control',
                'data-toggle' => "tooltip",
                'required' => true,
                "title" => "Introduzca nombre de estación de trabajo",
                'type' => 'text',
                'value' => $servicerequests["Servicerequest"]["name"],
                'readonly' => 'readonly'
            ));
            ?>
            <?php
