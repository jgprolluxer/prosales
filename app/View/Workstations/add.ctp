...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-pipe"></i><?php echo __('WORKSTATION_ADD_HEAD_TITLE'); ?><br><small><?php echo __('WORKSTATION_ADD_HEAD_TITLE_SMALL'); ?></small>
        </h1>
    </div>
</div>
...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('WORKSTATION_ADD_BLOCK_TITLE');?></h2>
    </div>
    ...
    <div class="block-content">
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('title', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('WORKSTATION_ADD_FORM_FIELD_TITLE')),
                'class' => 'form-control',
                'type' => 'text'
            ));
            ?>
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('description', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('WORKSTATION_ADD_FORM_FIELD_DESCRIPTION')),
                'class' => 'form-control',
                'type' => 'textarea'
            ));
            ?>
        ...
        <div class="form-group form-actions">
            <div class="col-sm-9 col-sm-offset-3">
                <button type="submit" class="btn btn-info"><?php echo __('WORKSTATION_ADD_FORM_BTN_SAVE'); ?></button>
            </div>
        </div>
        </form>
        <!-- END User Assist Content -->
    </div>
    <p class="text-muted"><?php echo __('WORKSTATION_ADD_BLOCK_CONTENT_FOOTER');?></p>
</div>
