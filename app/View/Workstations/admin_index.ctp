...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-pipe"></i><?php echo __('ADMIN_WORKSTATION_INDEX_HEAD_TITLE'); ?><br><small><?php echo __('ADMIN_WORKSTATION_INDEX_HEAD_TITLE_SMALL'); ?></small>
        </h1>
    </div>
</div>
...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('ADMIN_WORKSTATION_INDEX_BLOCK_TITLE'); ?></h2>
    </div>
    ...
    <div class="block-content">
        <?php
        echo $this->AclView->link(  __('ADMIN_WORKSTATION_INDEX_BLOCK_CONTENT_BTN_ADD'),
        ...
        ?>
        <section data-ng-controller="adminWorkstationsIndexController">
            <div class="table-responsive">
                <table class="table" datatable="ng" dt-options="dtOptions" dt-column-defs="dtColumnDefs" >
                    ...
                    <tr>
                        ...
                        <th><?php echo __('ADMIN_WORKSTATION_INDEX_LIST_FIELD_ROLE'); ?></th>
                        <th><?php echo __('ADMIN_WORKSTATION_INDEX_LIST_FIELD_STATUS'); ?></th>
                        <th><?php echo __('ADMIN_WORKSTATION_INDEX_LIST_FIELD_WORKAREA'); ?></th>
                        <th><?php echo __('ADMIN_WORKSTATION_INDEX_LIST_FIELD_STORE'); ?></th>
                        <th><?php echo __('ADMIN_WORKSTATION_INDEX_LIST_FIELD_PRICELIST'); ?></th>
                        <th><?php echo __('ADMIN_WORKSTATION_INDEX_LIST_ACTIONS'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
    ...
    <p class="text-muted"><?php echo __('ADMIN_WORKSTATION_INDEX_BLOCK_CONTENT_FOOTER');?></p>
