...
class GoogleMapV3Helper extends AppHelper
{
    ...
    const API = 'maps.google.com/maps/api/js?key=AIzaSyBh2L7bK7vZ4U5ilRWHth27KATsD-PlEqA&';
...
";
        ...
        unset($this->_currentOptions['div']['width']);
        unset($this->_currentOptions['div']['height']);
