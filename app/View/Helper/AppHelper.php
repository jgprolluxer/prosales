...
class AppHelper extends Helper
{
    ...
    function drawAccountMapView() {

        $modal = '';
        $modal .= '';
        $modal .= '<!-- mapViewModal -->';
        $modal .= '<div id="mapViewModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">';
        $modal .= '    <div class="modal-dialog">';
        $modal .= '        <div class="modal-content">';
        $modal .= '            <div class="modal-header">';
        $modal .= '                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
        $modal .= '                <h3 class="modal-title">Mapa</h3>';
        $modal .= '            </div>';
        $modal .= '            <div class="modal-body">';
        $modal .= $this->_View->element("Dialogs/accountmap_view");
        $modal .= '            </div>';
        $modal .= '            <div class="modal-footer">';
        $modal .= '                <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">Close</button>';
        $modal .= '            </div>';
