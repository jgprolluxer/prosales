          ...
          <div class="portlet box blue">
             ...
             <div class="portlet-body form">
				...
				<div class="row-fluid">
                   ...
                   <div class="span6 ">
	                	<?php echo $this->Form->input('type', array('type'=>'select', 'options'=> $actType,
		                	'label' => array('class' => 'control-label','text'=>__('Tipo'))
		                )); ?> 
		                <?php echo $this->Form->input('initial_status', array('type'=>'select', 'options'=> $actStatus,
		                ...
		                <?php echo $this->Form->input('duration_uom', array('type'=>'select', 'options'=> $actDurUOM,
