                ...
                <div class="widget-advanced widget-advanced-alt">
                    <form onsubmit="return false;">
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="example-text-input">Recibido: </label>
                            <div class="col-md-9">
                                <input type="number" data-ng-change="setTotalChange()" id="totalReceived" clas="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="example-text-input">Cambio: </label>
                            <div class="col-md-9">
                                <input type="number" id="totalChange" readonly="readonly" clas="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" clas="form-control" value="{{newOrder.Order.total_amt}}" readonly="readonly" />
                        </div>
