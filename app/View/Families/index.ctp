<div class="families index">
	...
	<tr>
		...
		<td><?php echo h($family['Family']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($family['Family']['updated_by']); ?>&nbsp;</td>
		<td><?php echo h($family['Family']['description']); ?>&nbsp;</td>
		<td><?php echo h($family['Family']['title']); ?>&nbsp;</td>
		<td><?php echo h($family['Family']['picture']); ?>&nbsp;</td>
		<td><?php echo h($family['Family']['color']); ?>&nbsp;</td>
		<td class="actions">
