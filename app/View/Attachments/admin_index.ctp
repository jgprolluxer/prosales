<div class="attachments index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('filedoc'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($attachment['Attachment']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($attachment['Attachment']['updated_by']); ?>&nbsp;</td>
		<td><?php echo h($attachment['Attachment']['description']); ?>&nbsp;</td>
		<td><?php echo h($attachment['Attachment']['title']); ?>&nbsp;</td>
		<td><?php echo h($attachment['Attachment']['filedoc']); ?>&nbsp;</td>
