...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">
                <?php echo __('Secuencias'); ?>				<small>Listado de Secuencias</small>
            </h3>
            <ul class="breadcrumb">       
                <li>
                    <i class="icon-home"></i>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    <div class="clearfix">
                        <div class="btn-group">
                            <a href="<?php echo Router::url("/sequences/add"); ?>" class="btn green"><i class="icon-plus"></i> <?php echo __('Agregar'); ?></a>
                        </div>
                    ...
                    <div id = "sample_1_wrapper" class = "dataTables_wrapper form-inline" role = "grid">
                        <table class = "table table-striped table-bordered table-hover dataTable" id = "sample_1" aria-describedby = "sample_1_info">
                            <thead>
                                <tr role = "row">
                                    <th class = "sorting" role = "columnheader" tabindex = "0" aria-controls = "sample_1" rowspan = "1"><?php echo __('Id');
                            ?></th>
                                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1"><?php echo __('Nombre'); ?></th>
                                    <th class="sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1"><?php echo __('Valor actual'); ?></th>
...
<script>
    ...
    $("#excel").click(function() {
        ...
        window.location = qualifyURL("/sequences/excel/" + value);

    });

    $("#pdf").click(function() {
        var value = $("#sample_1_filter").find('.m-wrap').val();
        window.location = qualifyURL("/sequences/pdf/" + value);
    });
</script>
