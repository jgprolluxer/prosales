    ...
    <div class="block-content">
        ...
        <div class="form-group form-actions">
            <div class="col-sm-9 col-sm-offset-3">
                <button type="submit" class="btn btn-info"><?php echo __('STORESPRODUCT_ADD_FORM_BTN_SAVE'); ?></button>
            </div>
        </div>
    </div>
    <p class="text-muted"><?php echo __('STORESPRODUCT_ADD_BLOCK_CONTENT_FOOTER'); ?></p>
</div>
<script type="text/javascript">
    /**
