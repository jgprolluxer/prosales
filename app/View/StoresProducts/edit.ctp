...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('STORESPRODUCT_EDIT_BLOCK_TITLE'); ?></h2>
    </div>
    ...
    <div class="block-content">
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('stock', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('STORESPRODUCT_ADD_FORM_FIELD_STOCK')),
                'class' => 'form-control',
                'type' => 'text'
            ));
            ?>
        ...
        <div class="form-group form-actions">
            <div class="col-sm-9 col-sm-offset-3">
                <button type="submit" class="btn btn-info"><?php echo __('STORESPRODUCT_EDIT_FORM_BTN_SAVE'); ?></button>
            </div>
        </div>
    </div>
    <p class="text-muted"><?php echo __('STORESPRODUCT_EDIT_BLOCK_CONTENT_FOOTER'); ?></p>
</div>