...
<?php echo $this->Form->create('StoresProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Stores Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('StoresProduct.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('StoresProduct.id'))); ?></li>
