...
<?php echo $this->Form->create('Appmenu'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Appmenu'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Appmenu.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Appmenu.id'))); ?></li>
