...
<div class="content-header">
	<div class="header-section">
		<h1>
			<i class="fa fa-bars fa-fw"></i><?php echo __('APPMENU_INDEX_HEAD_TITLE'); ?><br><small><?php echo __('APPMENU_INDEX_HEAD_TITLE_SMALL'); ?></small>
		</h1>
	</div>
</div>
...
<div class="block">
	...
	<div class="block-title">
		...
		<h2><?php echo __('APPMENU_INDEX_BLOCK_TITLE'); ?></h2>
	</div>
	...
	<div class="block-content">
		<?php
		echo $this->AclView->link(  __('APPMENU_INDEX_BLOCK_CONTENT_BTN_ADD'),
		...
		?>
			<div class="table-responsive">
				<table class="table" id="example-datatable">
					<thead>
					<tr>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_ID'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_PARENT'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_ORDER'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_KEY'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_TYPE'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_NAME'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_FIELD_TITLE'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_URL'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_CONTROLLER'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_ACTION'); ?></th>
						<th><?php echo __('APPMENU_INDEX_LIST_ACTIONS'); ?></th>
					</tr>
					</thead>
					<tbody>
						<?php
	...
	<p class="text-muted"><?php echo __('APPMENU_INDEX_BLOCK_CONTENT_FOOTER');?></p>
