...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-user fa-fw"></i><?php echo __('ADMIN_USER_VIEW_HEAD_TITLE'); ?><br><small><?php echo __('ADMIN_USER_VIEW_HEAD_TITLE_SMALL'); ?></small>
        </h1>
    </div>
</div>
...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('ADMIN_USER_VIEW_BLOCK_TITLE'); ?></h2>
    </div>
    ...
    <div class="block-content">
        ...
        <div class="form-group form-actions">
            <div class="col-sm-9 col-sm-offset-3">
            	<?php
            	echo $this->AclView->link(  __('ADMIN_USER_VIEW_BLOCK_CONTENT_BTN_GO_EDIT'),
    ...
    <p class="text-muted"><?php echo __('ADMIN_USER_VIEW_BLOCK_CONTENT_FOOTER'); ?></p>
</div>