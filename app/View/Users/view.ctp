        ...
        <div class="form-group form-actions">
            <div class="col-sm-9 col-sm-offset-3">
            	...
            	echo $this->AclView->link(  __('USER_VIEW_BLOCK_CONTENT_BTN_GO_EDIT'),
            		...
            		?>
            		<a href="javascript:;" data-toggle="modal" data-target="#userChangePassowrd" class="btn btn-warning"><?php echo __('Cambiar password'); ?></a>
            		<?php
...
<?php echo $this->App->drawUserChangePasswordModal(); ?> 