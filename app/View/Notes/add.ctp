...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="fa fa-file-text-o fa-fw"></i><?php echo __('NOTE_ADD_HEAD_TITLE'); ?><br><small><?php echo __('NOTE_ADD_HEAD_TITLE_SMALL'); ?></small>
        </h1>
    </div>
</div>
    ...
    <div class="block-content">
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('title', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('NOTE_ADD_FORM_FIELD_TITLE')),
                'class' => 'form-control',
                'type' => 'text'
            ));
            ?>
        ...
        <div class="form-group form-actions">
            <div class="col-sm-9 col-sm-offset-3">
                <button type="submit" class="btn btn-info"><?php echo __('NOTE_ADD_FORM_BTN_SAVE'); ?></button>
            </div>
        </div>
    </div>
    <p class="text-muted"><?php echo __('NOTE_ADD_BLOCK_CONTENT_FOOTER'); ?></p>
</div>
