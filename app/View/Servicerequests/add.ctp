...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-user"></i><?php echo __('Agregar'); ?><br>
            <small><?php echo __('Nueva Solicitud de Servicio'); ?></small>
        </h1>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                echo $this->Form->input('status', array(
                    ...
                    'class' => 'form-control',
                    'type' => 'hidden',
                    'value' => StatusOfServicerequest::Active,
                    'data-toggle' => "tooltip",
                    "title" => "This is a help tooltip!"
                ));
                ?>
            ...
            <div class="col-md-6">  
                ...
                echo $this->Form->input('workstation_id', array(
                    'label' => array('class' => 'col-md-4 control-label', 'text' => __('Responsable')),
                    'class' => 'form-control',
                    'data-toggle' => 'tooltip',
                    'title' => 'This is a help tooltip!'
                ));
