...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">
                <?php echo __('Planes de actividad'); ?>				<small>Listado de Planes de actividad</small>
            </h3>
            <ul class="breadcrumb">       
                <li>
                    <i class="icon-home"></i>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    <div class="clearfix">
                        <div class="btn-group">
                            <a href="<?php echo Router::url("/actplans/add"); ?>" class="btn green"><i class="icon-plus"></i> <?php echo __('Agregar'); ?></a>
                        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable" id="sample_1" aria-describedby="sample_1_info">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1"><?php echo __('Relacion'); ?></th>
                                    <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1"><?php echo __('Evento'); ?></th>			
...
<script>
    ...
    $("#excel").click(function() {
        ...
        window.location = qualifyURL("/actplans/excel/" + value);

    });

    $("#pdf").click(function() {
        var value = $("#sample_1_filter").find('.m-wrap').val();
        window.location = qualifyURL("/actplans/pdf/" + value);
    });
</script>
