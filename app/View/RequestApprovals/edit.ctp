...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-log_book"></i><?php echo __('Editar'); ?><br>
            <small><?php echo __('Editar Solicitud de Autorizacion'); ?></small>
        </h1>
    </div>
</div>
...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('Información de Solicitud'); ?></h2>
    </div>
    ...
    <div class="block-content">
        ...
        echo $this->Form->input('updated', array(
            'label' => array('class' => 'col-md-4 control-label', 'text' => __('Fecha de modificacion')),
            'class' => 'form-control',
            'data-toggle'=>"tooltip",
            'required' => true,
        ...
        <div class="form-group form-actions">
            <div class="col-md-9 col-md-offset-3">
                ...
                <a href="<?php echo Router::url("/RequestApprovals/delete/" . $this->request->data["RequestApproval"]["id"] . "/") ?>" class="btn btn-danger">
                    <?php echo __('Borrar'); ?>
                </a>
            </div>
        </div>
