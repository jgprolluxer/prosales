...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <h3 class="page-title">
                <?php echo __('Configuracion de flujos de trabajo'); ?>				<small>Listado de configuraciones de flujos de trabajo</small>
            </h3>
            <ul class="breadcrumb">       
                <li>
                    <i class="icon-home"></i>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body">
                    <div class="clearfix">
                        <div class="btn-group">
                            <a href="<?php echo Router::url("/taskflows/add"); ?>" class="btn green"><i class="icon-plus"></i> <?php echo __('Agregar'); ?></a>
                        </div>
...
<script>
    ...
    $("#excel").click(function() {
        ...
        window.location = qualifyURL("/taskflows/excel/" + value);

    });

    $("#pdf").click(function() {
        var value = $("#sample_1_filter").find('.m-wrap').val();
        window.location = qualifyURL("/taskflows/pdf/" + value);
    });
</script>
