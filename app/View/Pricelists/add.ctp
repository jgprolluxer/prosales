...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-group"></i><?php echo __('PRICELIST_ADD_HEAD_TITLE'); ?><br><small><?php echo __('PRICELIST_ADD_HEAD_TITLE_SMALL'); ?></small>
        </h1>
    </div>
</div>
    ...
    <div class="block-content">
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('tax', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('PRICELIST_ADD_FORM_FIELD_TAX')),
                'class' => 'form-control',
                'type' => 'text'
            ));
            ?>
