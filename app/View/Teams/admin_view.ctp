...
<div class="content-header">
    <div class="header-section">
        <h1>
            <i class="gi gi-group"></i><?php echo __('ADMIN_TEAM_VIEW_HEAD_TITLE'); ?><br><small><?php echo __('ADMIN_TEAM_VIEW_HEAD_TITLE_SMALL'); ?></small>
        </h1>
    </div>
</div>
...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('ADMIN_TEAM_VIEW_BLOCK_TITLE'); ?></h2>
    </div>
    ...
    <div class="block-content">
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('id', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_VIEW_FORM_FIELD_ID')),
                'class' => 'form-control',
                'type' => 'hidden',
                'readonly' => 'readonly'
            ));
            ...
            echo $this->Form->input('owner_id', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_VIEW_FORM_FIELD_OWNER')),
                'class' => 'form-control',
                'type' => 'text',
                'readonly' => 'readonly',
            ...
            echo $this->Form->input('name', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_VIEW_FORM_FIELD_NAME')),
                'class' => 'form-control',
                'type' => 'text',
                'readonly' => 'readonly'
            ));
            ...
            echo $this->Form->input('alias', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_VIEW_FORM_FIELD_ALIAS')),
                'class' => 'form-control',
                'type' => 'text',
                'readonly' => 'readonly'
            ));
            ...
            echo $this->Form->input('status', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_VIEW_FORM_FIELD_STATUS')),
                'class' => 'form-control',
                'type' => 'text',
                'readonly' => 'readonly'
            ));
