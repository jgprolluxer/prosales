    ...
    <div class="block-content">
        ...
        <div class="col-md-6">
            ...
            echo $this->Form->input('owner_id', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_ADD_FORM_FIELD_OWNER')),
                'class' => 'form-control',
                'type' => 'select',
                'options' => $owners
            ));
            ...
            echo $this->Form->input('name', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_ADD_FORM_FIELD_NAME')),
                'class' => 'form-control',
                'type' => 'text'
            ));
            ?>
            ...
            echo $this->Form->input('alias', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_ADD_FORM_FIELD_ALIAS')),
                'class' => 'form-control',
                'type' => 'text'
            ));
            ?>
            ...
            echo $this->Form->input('status', array(
                'label' => array('class' => 'col-md-4 control-label', 'text' => __('ADMIN_TEAM_ADD_FORM_FIELD_STATUS')),
                'class' => 'form-control',
                'type' => 'select',
