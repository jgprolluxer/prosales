...
<div class="content-header">
	<div class="header-section">
		<h1>
			<i class="gi gi-group"></i><?php echo __('ADMIN_TEAM_INDEX_HEAD_TITLE'); ?><br><small><?php echo __('ADMIN_TEAM_INDEX_HEAD_TITLE_SMALL'); ?></small>
		</h1>
	</div>
</div>
			...
			<div class="table-responsive">
				<table class="table" id="example-datatable">
					...
					<tr>
						...
						<th><?php echo __('ADMIN_TEAM_INDEX_LIST_FIELD_OWNER'); ?></th>
						<th><?php echo __('ADMIN_TEAM_INDEX_LIST_FIELD_NAME'); ?></th>
						<th><?php echo __('ADMIN_TEAM_INDEX_LIST_FIELD_ALIAS'); ?></th>
						<th><?php echo __('ADMIN_TEAM_INDEX_LIST_FIELD_STATUS'); ?></th>
