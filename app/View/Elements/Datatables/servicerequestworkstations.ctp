...
<div class="block">
    ...
    <div class="block-content">
        <div class="block-section">
            <a href="<?php echo Router::url("/ServicerequestWorkstations/add/".$servicerequest["Servicerequest"]["id"]); ?>" class="btn btn-success">
                <?php echo __('Agregar estacion'); ?>
            </a>
        </div>
        <div class="table-responsive">
            <table id="dt_servicerequestworkstations" class="table table-vcenter table-striped table-condensed table-hover">
                <thead>
                    <tr>
...
<script>
    $(document).ready(function() {
        var url = qualifyURL("/ServicerequestWorkstations/jsindex/<?php echo $servicerequest['Servicerequest']['id']; ?>/");
        /* Initialize Bootstrap Datatables Integration */
        App.datatables();
        
        /* Initialize Datatables */
        $('#dt_servicerequestworkstations').dataTable({
            "iDisplayLength": 8,
