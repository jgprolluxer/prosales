...
<div class="block">
    ...
    <div class="block-content">
        <div class="table-responsive text-center">
            <table id="dt_archiveWorkarea" class="table table-vcenter table-striped table-condensed table-hover">
                <thead>
                    <tr>
...
<script>
    $(document).ready(function() {
        var url = qualifyURL("/Workareas/jsarchive");
        /* Initialize Bootstrap Datatables Integration */
        App.datatables();
        
        /* Initialize Datatables */
        $('#dt_archiveWorkarea').dataTable({
            "iDisplayLength": 8,
