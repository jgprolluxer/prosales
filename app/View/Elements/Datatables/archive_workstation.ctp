...
<div class="block">
    ...
    <div class="block-content">
        <div class="table-responsive text-center">
            <table id="dt_archiveWorkstation" class="table table-vcenter table-striped table-condensed table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><?php echo __('Padre'); ?></th>
                        <th class="text-center"><?php echo __('Departamento'); ?></th>
...
<script>
    $(document).ready(function() {
        var url = qualifyURL("/Workstations/jsarchive");
        /* Initialize Bootstrap Datatables Integration */
        App.datatables();
        
        /* Initialize Datatables */
        $('#dt_archiveWorkstation').dataTable({
            "iDisplayLength": 8,
