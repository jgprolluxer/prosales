...
<div class="block">
    ...
    <div class="block-content">
        <div class="table-responsive text-center">
            <table id="dt_archiveResources" class="table table-vcenter table-striped table-condensed table-hover">
                <thead>
                    <tr>
                        <th class="text-center"><?php echo __('ID'); ?></th>
                        <th class="text-center"><?php echo __('Nombre'); ?></th>
                        <th class="text-center"><?php echo __('Tipo'); ?></th>
                        <th class="text-center"><?php echo __('Subtipo'); ?></th>
...
<script>
    $(document).ready(function() {
        var url = qualifyURL("/Resources/jsarchive");
        /* Initialize Bootstrap Datatables Integration */
        App.datatables();
        
        /* Initialize Datatables */
        $('#dt_archiveResources').dataTable({
            "iDisplayLength": 8,
