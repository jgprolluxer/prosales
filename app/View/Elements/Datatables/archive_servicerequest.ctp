...
<div class="block">
    ...
    <div class="block-title">
        ...
        <h2><?php echo __('Solicitudes de Servicio'); ?></h2>
    </div>
    ...
    <div class="block-content">
        <div class="table-responsive text-center">
            <table id="dt_archiveServicerequest" class="table table-vcenter table-striped table-condensed table-hover">
                <thead>
                    <tr>
                        <th class="text-center"><?php echo __('ID'); ?></th>
                        <th class="text-center"><?php echo __('Nombre'); ?></th>
                        <th class="text-center"><?php echo __('Descripción'); ?></th>
                        <th class="text-center"><?php echo __('Estación de trabajo'); ?></th>
                        <th class="text-center"><?php echo __('Prioridad'); ?></th>
                        <th class="text-center"><?php echo __('Día de reporte'); ?></th>
                        <th class="text-center"><?php echo __('Día de resolución'); ?></th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script>
    $(document).ready(function() {
        var url = qualifyURL("/Servicerequests/jsarchive");
        /* Initialize Bootstrap Datatables Integration */
        App.datatables();
        
        /* Initialize Datatables */
        $('#dt_archiveServicerequest').dataTable({
            "iDisplayLength": 8,
