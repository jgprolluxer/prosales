...
<div class="block">
    ...
    <div class="block-content">
        <div class="block-section">
            <a href="<?php echo Router::url("/ResourceLevels/add/".$resource["Resource"]["id"]); ?>" class="btn btn-success">
                <?php echo __('Agregar nivel'); ?>
            </a>
        </div>
        <div class="table-responsive">
            <table id="dt_resourcelevels" class="table table-vcenter table-striped table-condensed table-hover">
                <thead>
                    <tr>
                        <th class="text-center"><?php echo __('ID'); ?></th>
                        <th class="text-center"><?php echo __('Orden'); ?></th>
                        <th class="text-center"><?php echo __('Recurso'); ?></th>
                        <th class="text-center"><?php echo __('Puesto de trabajo'); ?></th>
...
<script>
    $(document).ready(function() {
        var url = qualifyURL("/ResourceLevels/jsindex/<?php echo $resource['Resource']['id']; ?>/");
        /* Initialize Bootstrap Datatables Integration */
        App.datatables();
        
        /* Initialize Datatables */
        $('#dt_resourcelevels').dataTable({
            "iDisplayLength": 8,
