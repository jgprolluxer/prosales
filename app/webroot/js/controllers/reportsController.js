...
angular.module('prosales-app')
    .controller('adminIndexReportsController', function ($scope, $http, DTOptionsBuilder, DTColumnDefBuilder)
    {
        ...
        {
            //////Load Reports
            $http.get("/Reports/admnJsIndex/").success(function (data)
            {
        ...
        $scope.dtOptions = DTOptionsBuilder.newOptions()
            ...
            .withOption("columnDefs", [ { orderable: false, targets: [ 1, 5 ] } ])
            .withOption("pageLength", 10)
            .withOption("lengthMenu", [[10, 20, 30, -1], [10, 20, 30, 'All']])
