...
angular.module('prosales-app')
    .controller('adminWorkstationsIndexController', function ($scope, $http, DTOptionsBuilder, DTColumnDefBuilder)
    {
        ...
        {
            //////Load Workstations
            $http.get("/Workstations/adminjsIndex/").success(function (data)
            {
                if (data)
                {
                    if (data["success"])
                    {
                        $scope.workstations = data["xData"];
                    } else
                    {
                        alert(data["message"]);
                    }
    ...
    .controller('WorkstationsIndexController', function ($scope, $http, DTOptionsBuilder, DTColumnDefBuilder)
    {
        ...
        {
            //////Load Workstations
            $http.get("/Workstations/jsIndex/").success(function (data)
            {
                if (data)
                {
                    if (data["success"])
