...
angular.module('prosales-app')
    .controller('adminStoresIndexController', function ($scope, $http, DTOptionsBuilder, DTColumnDefBuilder)
    {
        ...
        {
            //////Load Stores
            $http.get("/Stores/adminjsIndex/").success(function (data)
            {
                if (data)
                {
                    if (data["success"])
                    {
                        $scope.stores = data["xData"];
                    } else
                    {
                        alert(data["message"]);
                    }
    ...
    .controller('StoresIndexController', function ($scope, $http, DTOptionsBuilder, DTColumnDefBuilder)
    {
        ...
        {
            //////Load Stores
            $http.get("/Stores/jsIndex/").success(function (data)
            {
                if (data)
                {
                    if (data["success"])
