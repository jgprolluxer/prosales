...
/**
 *
 * Si hay un string como 'el producto' regresa true
 *
 * @param string
 * @returns {boolean}
 */
...
/**
 * @description retorna un id numerico random,
 * IMPORTANTE: se usa solo temporalmente, el ID puede repetirse
...
/**
 * 
 * @param {type} form =  jquery support #formid
 * @returns {undefined}
 */
...
/***********BEGIN RANDOM NAME NUMBER ETC ETC***********************************/
